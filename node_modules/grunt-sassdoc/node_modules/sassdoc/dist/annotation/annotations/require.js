...
var _splitNamespace = require('../../utils');
...
exports['default'] = function (env) {
  return {
    ...
    parse: function parse(text) {
      ...
      obj.external = _splitNamespace.splitNamespace(obj.name).length > 1;
...
function searchForMatches(code, regex, isAnnotatedByHandProxy) {
  var id = arguments[3] === undefined ? 1 : arguments[3];
