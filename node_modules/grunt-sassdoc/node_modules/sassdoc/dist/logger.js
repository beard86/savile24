...
var _import = require('./errors');

var errors = _interopRequireWildcard(_import);

var _fmt = require('util');

var _chalkModule = require('chalk');

var _chalkModule2 = _interopRequireWildcard(_chalkModule);

var chalk = new _chalkModule2['default'].constructor({
...
var Logger = (function () {
  ...
  Logger.prototype.log = function log() {
    ...
    if (this.verbose) {
      var str = _fmt.format.apply(undefined, ['' + green + ' ' + args.shift()].concat(args));
  ...
  Logger.prototype.warn = function warn() {
    ...
    var str = _fmt.format.apply(undefined, ['' + yellow + ' [WARNING] ' + args.shift()].concat(args));
    this._stderr.write('' + str + '\n');
  };
  ...
  Logger.prototype.error = function error() {
    ...
    var str = _fmt.format.apply(undefined, ['' + red + ' [ERROR] ' + args.shift()].concat(args));
    this._stderr.write('' + str + '\n');
  };
  ...
  Logger.prototype.timeEnd = function timeEnd(label) {
    ...
    var str = _fmt.format('' + chalk.green(checkmark) + ' ' + format, label, duration);
    this._stderr.write('' + str + '\n');
  };
  ...
  Logger.prototype.debug = function debug() {
    ...
    var str = _fmt.format.apply(undefined, ['' + _chalkModule2['default'].styles.grey.open + '' + chevron + ' [DEBUG] ' + args.shift()].concat(args, [_chalkModule2['default'].styles.grey.close]));
...
var empty = {
  ...
  debug: function debug() {} };exports.empty = empty;

function checkLogger(logger) {
  var methods = ['log', 'warn', 'error'].filter(function (x) {
    return !(x in logger) || !_is.is['function'](logger[x]);
  });
