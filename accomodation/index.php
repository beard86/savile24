							...
							<div class="three pad-left-xlg full-h">
								<div class="tabled">
									<div class="rel">
										...
										<p class="pad-bottom">2,971 sq ft / 271 sq m</p>
										<p class="qpad-bottom">Occupancy 1:10m<sup>2</sup></p>
						...
						<div class="item space-plans">
							<div class="three pad-left-xlg full-h">
								<div class="tabled">
									<div class="rel">
										<h3>Fifth Floor</h3>
										<p class="pad-bottom">3,789 sq ft / 352 sq m</p>
										<p class="qpad-bottom">Occupancy 1:10m<sup>2</sup></p>
										<p>2 person reception<span>1</span></p>
										<p>Open plan workstation<span>1</span></p>
										<p>Office<span>1</span></p>
							...
							<div class="three pad-left-xlg full-h">
								<div class="tabled">
									<div class="rel">
										...
										<p class="pad-bottom">4,478 sq ft / 416 sq m</p>
										<p class="qpad-bottom">Occupancy 1:10m<sup>2</sup></p>
										<p>2 person reception<span>1</span></p>
										<p>Open plan workstation<span>1</span></p>
										<p>Office<span>1</span></p>
						...
						<div class="item space-plans">
							<div class="three pad-left-xlg full-h">
								<div class="tabled">
									<div class="rel">
										<h3>Third Floor</h3>
										<p class="pad-bottom">4,483 sq ft / 416 sq m</p>
										<p class="qpad-bottom">Occupancy 1:10m<sup>2</sup></p>
										<p>2 person reception<span>1</span></p>
										<p>Open plan workstation<span>1</span></p>
										<p>Office<span>1</span></p>
						...
						<div class="item space-plans">
							<div class="three pad-left-xlg full-h">
								<div class="tabled">
									<div class="rel">
										<h3>Second Floor</h3>
										<p class="pad-bottom">Let</p>
										<p class="bold">Open plan layout</p>
										<p class="qpad-bottom">Occupancy 1:10m<sup>2</sup></p>
										<p>2 person reception<span>1</span></p>
										<p>Open plan workstation<span>1</span></p>
										<p>Office<span>1</span></p>
						...
						<div class="item space-plans">
							<div class="three pad-left-xlg full-h">
								<div class="tabled">
									<div class="rel">
										<h3>First Floor</h3>
										<p class="pad-bottom">1,647 sq ft / 153 sq m</p>
										<p class="bold">Open plan layout</p>
										<p class="qpad-bottom">Occupancy 1:10m<sup>2</sup></p>
										<p>2 person reception<span>1</span></p>
										<p>Open plan workstation<span>1</span></p>
						...
						<div class="item space-plans">
							<div class="three pad-left-xlg full-h">
								<div class="tabled">
									<div class="rel">
										<h3>Reception</h3>
										<p class="pad-bottom">840 sq ft / 78 sq m</p>
										<p class="bold">Open plan layout</p>
										<p class="qpad-bottom">Occupancy 1:10m<sup>2</sup></p>
										<p>2 person reception<span>1</span></p>
										<p>Open plan workstation<span>1</span></p>
